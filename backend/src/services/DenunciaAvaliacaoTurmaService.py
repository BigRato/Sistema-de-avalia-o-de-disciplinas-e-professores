...
class DenunciaAvaliacaoTurmaService:
    def __init__(self, database):
        self.database = database

    def read(self):
      query_string = 'SELECT * FROM DENUNCIA_AVALIACAO_TURMA;'
    ...
    def readOne(self, id):
      ...
      query_string = 'SELECT * FROM DENUNCIA_AVALIACAO_TURMA WHERE ID = %s;'
      ...
      json_response = {
        'id': tuple_result[0],
        'avaliacao_turma_id': tuple_result[1],
